...
public class JobSeekerProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			query="select ID, fname, minit, lname, Date_of_birth, city, state, country, zipcode, Phone_cell, phone_Home, phone_work, my_resume, salary, Desired_position, willing_to_relocate from job_Seeker_Profile where ID=1005";
