...
import com.santhi.pkg.DatabaseConnection;
...
public class EditEmployerList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			query = "select Employer_Id, Job_ID, job_Title, job_description, Company_Name, job_location, Date_Posted, job_Salary, contact_person, Phone_Number from Job_Post where Employer_Id=8";
